...
c
      ...
      double precision, allocatable :: ign(:)
...
c
     ...
     >           roc, rocsup, roclow, ipt, alpha, venv, jcount,ign)
c
c.... write reliability and Brier score (and Ignorance?)
c
              if(narea.ne.1)then
...
c    >              xprob(1,iprob),yprob(1,iprob)
              enddo
              write(10,'(12f10.4)')bss_ful(1),bss_red(1),bss_inf(1),
     >           rel(1),bss_rel(1),
     >           res(1),bss_res(1),unc(1),totocc_rel(1),
     >           ave_prob(1),sd_prob(1),ign(1)
              write(*,'(12f10.4)')bss_ful(1),bss_red(1),bss_inf(1),
     >           rel(1),bss_rel(1),
     >           res(1),bss_res(1),unc(1),totocc_rel(1),
     >           ave_prob(1),sd_prob(1),ign(1)
c
...
c    >                   xprob(1,iprob),yprob(1,iprob)
                   enddo
                   write(11,'(12f10.4)')bss_ful(1),bss_red(1),
